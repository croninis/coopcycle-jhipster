    ...
    public ResponseEntity<Livreur> partialUpdateLivreur(
        ...
        Optional<Livreur> result = livreurRepository
            ...
            .map(existingLivreur -> {
                ...
                if (livreur.getNbEarnings() != null) {
                    existingLivreur.setNbEarnings(livreur.getNbEarnings());
                }
                if (livreur.getNbRides() != null) {
                    existingLivreur.setNbRides(livreur.getNbRides());
                }
